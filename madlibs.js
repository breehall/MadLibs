...
const submitMadLibs = (event) => {
    ...
    let story = `
        ...
        <span class="inserted-text">${userSubmission.sport_2}</span>, 
        and <span class="inserted-text">${userSubmission.sport_3}</span>. Hot <span class="inserted-text">${userSubmission.beverage}</span>
...
const loadStory = (userSubmission) => {
